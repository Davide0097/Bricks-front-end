    ...
    <div>
      ...
      <div className="2xl:px-20 sm:p-10 w-full bg-gradient-to-b from-slate-300 to-white pt-40">
        <div className="flex flex-col justify-center items-center">
          ...
          <h1
            ...
            <b className='uppercase bg-black text-white py-1 inline-block px-2 shadow-xl'>Speed up</b> your deployment
          </h1>
          ...
          <div className="p-8 flex flex-col sm:flex-row justify-center items-center">
            <Link to="/TemplatesPage">
              <button className="border-[1px] rounded-3xl m-2 bg-black h-[50px] w-[180px] hover:bg-white hover:border-[2px] group hover:border-black">
                <p className="text-white group-hover:text-black group-hover:font-bold">Templates →</p>
              </button>
            </Link>
      ...
      <Link to={"/BricksHub"}>
        <div className='bg-slate-100 py-4 sm:py-6 border-[1px]'>
          ...
          sm:px-20 lg:mt-28 2xl:m-20 text-center mt-20 tracking-thight">
            Become a part of our growing community with <b className='bg-black text-white py-1 inline-block px-2 uppercase shadow-xl'>Brickshub</b>
          </h1>
            ...
            <div className='border-slate-300 border-[1px] m-3 bg-white bg-gradient-to-r from-slate-200 to-white rounded-xl hover:from-white shadow-xl'>
              ...
              <div className='mt-1 h-[300px] w-[300px] overflow-auto author-showcase'>
                {(components && components.map((component) => (
                  <div key={component.componentName} className='hover:bg-slate-300 text-slate-500 text-xl text-center'>
                    <ComponentTitleEditor className="m-0 p-0" title={component.componentName} />
                  </div>
                )))}
              </div>
          ...
          <div className="2xl:px-60 grid grid-cols-10 gap-4  px-4 sm:px-20 bg-slate-100 ">
            <div
              className="col-span-4 max-[900px]:col-span-10 col-rows-2  row-span-2 shadow-xl rounded-xl w-100 border-[1px] text-center cursor-pointer bg-white sm:py-20 ">
              <div className="flex flex-col justify-center items-center p-6">
                <div className='w-[270px] flex flex-row mt-14 items-center px-2 bg-black justify-center shadow-xl'>
            ...
            <div className="max-[900px]:col-span-10 col-span-3  bg-white rounded-xl text-center flex flex-col justify-center items-center shadow-xl  p-2 border-[1px] cursor-pointer ">
              ...
              className="max-[900px]:col-span-10 col-span-3 bg-white text-center rounded-xl border-[1px] cursor-pointer shadow-xl overflow-hidden p-2">
            ...
            <div className="max-[900px]:col-span-10 col-span-3 bg-white flex flex-col justify-center items-center rounded-xl text-center border-[1px] py-6 cursor-pointer shadow-xl">
            ...
            <div className=" max-[900px]:col-span-10 col-span-3  bg-white text-center rounded-xl cursor-pointer py-4 border-[1px] flex flex-col justify-center items-center shadow-xl">
      ...
      <div className="2xl:px-40 bg-slate-100 py-20 flex flex-col justify-center items-center h-auto">
        ...
        <div className="flex flex-col items-center">
          <div>
            ...
            <img src={componentNav} alt="navigation bars card" className="-rotate-12 duration-75 w-[300px] hover:rotate-0 h-[200px] border-[3px] rounded-md md:mr-[900px] -mb-40 " /></div>
          <div>
            ...
            <img src={componentCard} alt="cards card" className="-rotate-12 mt-28 sm:mt-2 duration-75 hover:rotate-0 h-[200px] w-[300px] border-[3px] rounded-md md:mr-[700px] -mb-40" /></div>
          <div>
            ...
            <img src={componentButt} alt="buttons card" className="-rotate-12 mt-28 sm:mt-2 w-[300px] h-[200px] border-[3px] rounded-md  md:mr-[300px] -mb-40 hover:rotate-0 duration-75" />
          </div>
          <div>
            ...
            <img src={componentOther} alt="others components card" className="-rotate-12 duration-75 hover:rotate-0 h-[200px] mt-28 sm:mt-2 md:ml-[300px] border-[3px] rounded-md w-[300px] -mb-28  " />
          </div>
        </div>
      ...
      <div className="2xl:px-60 bg-slate-100 py-20 flex flex-col justify-center items-center border-[1px] border-slate-300">
        ...
        <div className="w-full grid grid-cols-1 2xl:px-40 md:grid-cols-3 mx-2 md:px-40 gap-10 py-10">
          ...
          <div className="border border-slate-300 min-w[300px] m-2 bg-white rounded-xl p-4 shadow-xl">
      ...
      <div className="2xl:px-40 bg-white w-100 px-4 sm:px-20 py-20 grid grid-cols-4 gap-0 justify-center items-center border-[1px] border-slate-300">
        ...
        <div className="col-span-4 lg:col-span-1 text-center py-2 justify-center items-center">
          <button onClick={() => { setShowForm(true); }}
            ...
            <p className="text-white  group-hover:text-black group-hover:font-bold text-xl">Contacts</p>
          </button>
        </div>
      </div>
    </div>
