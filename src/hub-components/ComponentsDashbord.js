// Overview: Components dashboard for brickshub
...
import DeleteFormComponent from './forms/DeleteFormComponent';

const ComponentDashbord = ({ components, filteredSubmissionsComponents, componentsCount, cssComponents, cssComponentsCount, onSelectedButtonChange }) => {
            ...
            <div className='xl:grid xl:grid-cols-2 min-[500px]:p-5'>
                ...
                {showFormComponent && (
                    <div className=' col-span-2 bg-slate-800 rounded-xl p-2 m-1'>
                        ...
                        <DeleteFormComponent selectedComponent={selectedComponent} />
                ...
                <div className='bg-slate-800 h-[375px] p-1 rounded-2xl  overflow-auto m-1'>
                    <div className='flex flex-row p-2 justify-left items-center mb-3 3 border-b-[2px] border-slate-900'>
                        ...
                        <p className="text-md uppercase font-bold p-1 text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-blue-600 ">Published components</p>
                        <Link to={"/ComponentPage"} className='max-[500px]:hidden text-right font-semibold text-slate-400 text-sm ml-auto mr-2 underline'>
                            <p >
                                Go to Components &rarr;
                            </p></Link>
                    </div>

                    {componentsCount === 0 ? <>
                        <div className='flex flex-col justify-center items-center'>
                            <h1 className="text-slate-400  text-md md:py-6 p-2 md:px-14"><b>Welcome, </b>It seems that there are currently <b>no published components</b> visible on the dashboard. <br /><br />
                                If you have already submitted a component, please check back later. Otherwise, consider creating a new component to share with your audience.</h1>
                        </div>
                    </> : (
                        components.map(component => (

                            (<div key={component.componentName} className=" flex flex-row px-2 py-1 cursor-pointer hover:bg-slate-900 justify-left items-center">
                                <div className='flex flex-col justify-left items-left'>
                                    <h1 className="text-slate-100 font-bold text-md p-1">{component.componentName}</h1>
                                </div>
                                ...
                                <div className='ml-3 mt-1 bg-slate-800 rounded-[140px] border-slate-400 border-[1px]'>
                                    <p className="font-semibold text-slate-400 text-sm px-3 ">Tailwind</p>
                                </div>
                                <button onClick={() => {
                                    setShowFormComponent(true);
                                    setSelectedComponent(component);
                                }} className='cursor-pointer flex flex-row p-4 ml-auto mr-2'>
                ...
                {/* Published css components */}
                <div className='bg-slate-800 h-[375px] p-1 rounded-2xl  overflow-auto m-1'>
                    <div className='flex flex-row p-2 justify-left items-center mb-3 3 border-b-[2px] border-slate-900'>
                        <svg fill="currentColor" viewBox="0 0 16 16" height="1em" width="1em" aria-hidden="true" className="flex-shrink-0 w-8 h-8 text-slate-200 m-1">
                            <path d="M7 2.5a.5.5 0 01.5-.5h7a.5.5 0 01.5.5v1a.5.5 0 01-.5.5h-7a.5.5 0 01-.5-.5v-1zM2 1a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V3a2 2 0 00-2-2H2zm0 8a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H2zm.854-3.646a.5.5 0 01-.708 0l-1-1a.5.5 0 11.708-.708l.646.647 1.646-1.647a.5.5 0 11.708.708l-2 2zm0 8a.5.5 0 01-.708 0l-1-1a.5.5 0 01.708-.708l.646.647 1.646-1.647a.5.5 0 01.708.708l-2 2zM7 10.5a.5.5 0 01.5-.5h7a.5.5 0 01.5.5v1a.5.5 0 01-.5.5h-7a.5.5 0 01-.5-.5v-1zm0-5a.5.5 0 01.5-.5h5a.5.5 0 010 1h-5a.5.5 0 01-.5-.5zm0 8a.5.5 0 01.5-.5h5a.5.5 0 010 1h-5a.5.5 0 01-.5-.5z" />
                        </svg>
                        <p className="text-md uppercase font-bold p-1 text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-blue-600 ">Published CSS components</p>
                        <Link to={"/ComponentPage"} className='max-[500px]:hidden text-right font-semibold text-slate-400 text-sm ml-auto mr-2 underline'>
                            <p >
                                Go to Components &rarr;
                            </p></Link>
                    ...
                    {cssComponentsCount === 0 ? <>
                        ...
                        cssComponents.map(component => (
                            ...
                            (<div key={component.componentName} className=" flex flex-row px-2 py-1 cursor-pointer hover:bg-slate-900 justify-left items-center">
                                ...
                                <div className='ml-3 mt-1 bg-slate-800 rounded-[140px] border-slate-400 border-[1px]'>
                                    <p className="font-semibold text-slate-400 text-sm px-3 ">CSS</p>
                                </div>
                                <button onClick={() => {
                                    setShowFormComponent(true);
                                    setSelectedComponent(component);
                ...
                {/* submitted component */}
                <div className="bg-slate-800 p-1 row-span-2 rounded-2xl h-[400px] md:h-[500px] overflow-auto m-1">
                    <div className='flex flex-row p-2 justify-left items-center  mb-3 border-b-[2px] border-slate-900 '>
                        <svg viewBox="0 0 1000 1000" fill="currentColor" height="1em" className="flex-shrink-0 w-8 h-8 text-slate-200 m-1" width="1em" aria-hidden="true">
                            <path d="M900 50c28 0 51.667 10 71 30s29 43.333 29 70v600c0 28-9.667 51.667-29 71s-43 29-71 29H702v-98h200V290H100v462h200v98H100c-26.667 0-50-9.667-70-29S0 778 0 750V150c0-26.667 10-50 30-70s43.333-30 70-30h800M130 218c25.333 0 38-12.667 38-38 0-10.667-3.667-19.333-11-26-7.333-6.667-16.333-10-27-10-10.667 0-19.667 3.667-27 11-7.333 7.333-11 15.667-11 25 0 10.667 3.667 19.667 11 27 7.333 7.333 16.333 11 27 11m100 0c25.333 0 38-12.667 38-38 0-10.667-3.667-19.333-11-26-7.333-6.667-16.333-10-27-10-10.667 0-19.667 3.667-27 11-7.333 7.333-11 15.667-11 25 0 10.667 3.667 19.667 11 27 7.333 7.333 16.333 11 27 11m672-6v-62H300v62h602M498 410l242 240H590v300H406V650H256l242-240" />
                        </svg>
                        <p className=" text-md uppercase font-bold p-1 text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-blue-600 ">Submitted components</p>
                    ...
                    {filteredSubmissionsComponents.length === 0 ? <div className='flex flex-col justify-center items-center'>
                        <h1 className="text-slate-400  text-md md:py-6 p-2 md:px-14">It appears that there are no <b>components </b>currently visible on the dashboard.
                            We suggest submitting your first piece of content to populate this dashboard.</h1>
                    </div> : (
                        filteredSubmissionsComponents.map((submission) =>

                        (<div key={submission.createdAt} className=" flex flex-row px-2 py-3 cursor-pointer hover:bg-slate-900  justify-left items-center">
                            <div className='flex flex-col justify-left items-left'>
                                <h1 className="text-slate-400 font-bold text-sm px-1">Component title:</h1>
                                <h1 className="text-slate-100 font-bold text-md p-1">{submission.title.split(" ").slice(1).join(" ")}</h1>
                                <h1 className="text-slate-400 font-bold text-sm px-1">Component description:</h1>
                ...
                <Link to={"/RequirmentsPage"} className="bg-slate-800  rounded-2xl grid grid-cols-2 m-1">
                    ...
                    <div className="bg-slate-900 w-100 rounded-2xl p-2  m-1">
                        <svg aria-hidden="true" class="flex-shrink-0 w-12 h-12 text-slate-200 m-1 p-2" fill="white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="p-2 text-left font-semibold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-blue-600">Images requirments &rarr;</span>
                    </div>
                    <div className="bg-slate-900  w-100 rounded-2xl p-2  m-1">
                        <svg aria-hidden="true" class="flex-shrink-0 w-12 h-12 text-slate-200 m-1 p-2" fill="white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path
                            ...
                            /></svg>
                        <span class="p-2  text-left font-semibold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-blue-600">Text requirments &rarr;</span>
                    </div>
                </Link>
                ...
                <div className='bg-slate-800 col-span-2 rounded-2xl p-1 overflow-auto mb-5 m-1'>
                    <div className='flex flex-row p-2 justify-left items-center mb-3 border-b-[2px] border-slate-900'>
                        ...
                        <p className=" text-md uppercase font-bold p-1 text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-blue-600 ">Submit a new component</p>
                    </div>
                    <ComponentForm />
                </div>
            </div>
...
export default ComponentDashbord;