// Overview: Form for delete a component

// User context
import { useUserContext } from '../../hooks/useUserContext'

function DeleteFormComponent({ selectedComponent }) {
    ...
    return (
        <form className="flex flex-col" target="_blank" action="https://mailthis.to/buildthewebfaster@gmail.com" method="POST" encType="multipart/form-data">
            ...
            <input type="hidden" name="_subject" value="New edit request for component" />
            <input type="hidden" name="Component" value={selectedComponent.componentName} />

            {/* Request */}
            <p className='font-semibold text-slate-400 text-md p-1'>
                Explain in a few lines the changes you want to make to "{selectedComponent.componentName}"
            </p>
