...
const SinglePost = ({ post }) => {
    ...
    return (
        <div>
            <div className="shadow-xl border border-slate-300 min-w[300px] min-h-[200px] rounded-xl p-4 bg-gradient-to-r from-slate-200 to-white">
                ...
                <h1 className='text-xl  font-bold text-transparent bg-clip-text p-1 bg-gradient-to-r from-black to-pink-600 mt-10'>{post.postTitle}</h1>
